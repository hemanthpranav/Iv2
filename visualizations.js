class CarVisualization {
    ...
    renderBarChart(data) {
        ...
        // Create color scale for manufacturers
...
.on("mouseout", () => {
    ...
    svg.append("text")
        ...
        if (this.clickedDatum?.type === "scatter") {
            const d = this.clickedDatum.data;
            svg.append("text")
                .attr("class", "label")
        ...
        if (this.clickedDatum?.type === "box") {
            const { origin, median, xPos } = this.clickedDatum;
            svg.append("text")
                .attr("class", "label")
                .attr("x", xPos + 10)
                .attr("y", y(median) - 10)
...
.on("click", (event) => {
    ...
    this.clickedDatum = { type: "box", origin, median, xPos };
